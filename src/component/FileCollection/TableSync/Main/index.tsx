	...
	public render() {
		return (
			<div className={style.container}>
				<Search getTableSyncDataList={this.getTableSyncDataList} searchValue={this.state.searchValue} changeSearchValue={this.changeSearchHandler}
					resetHandler={this.resetHandler}
				/>
				<DataList pageValue={this.state.pageValue} dataList={this.state.dataList} changePage={this.changePageNumber} />
			</div>
		);
	}
